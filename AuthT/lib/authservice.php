...
/**
 * Class AuthService
 * @package VetalB\Tauth
 */
class AuthService extends CSocServAuth
{
    const ID = 'Telegram';
    const WIDGET_URL = 'link';
    ...
    public static function onAuthServicesBuildList()
    {
        ...
        $APPLICATION->SetAdditionalCSS('/bitrix/js/VetalB.tauth/css/ss.css');
    ...
    {
        return [
            ['bot_username', Loc::getMessage('VT_TAUTH_BOT_USERNAME'), '', ['text', 40, ], ],
            ['bot_token', Loc::getMessage('VT_TAUTH_BOT_TOKEN'), '', ['text', 40, ], ],
